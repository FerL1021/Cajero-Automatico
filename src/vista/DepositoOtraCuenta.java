...
public class DepositoOtraCuenta extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Obtener los valores de los campos a ingresar
        String nrodepText = nrodeposito.getText();
        String cantdepoText = cantdeposito.getText();
        // Verificar que los campos a llenar no estén vacíos y que solo contengan números no letras
        ...
        // Verificar si el número de cuenta ingresado es válido, o si es que existe y de esta manera realizar el depósito
        ...
        // Muestra el mensaje si el depósito fue exitoso si es un  número de cuenta inválido
        if (depositoExitoso) {
    ...
    /*Este metodo guarda la lista de saldos en un  archivo, cada saldo se escribe con el formato
    nro de Cuenta, tipo de moneda y el saldo*/
    ...
    public void datos(String nombre, int nro,String selec,String apellido,int idioma) {
     ...
     /*Este metodo se encarga de leer el archivo de Usuario, de esta manera extraer la informacion sobre las cuentas del usuario
     y llenar una lista de cuentas con objetos de tipo de cuenta*/
