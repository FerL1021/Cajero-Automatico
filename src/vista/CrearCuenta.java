...
public class CrearCuenta extends javax.swing.JFrame {
 ...
 /*Esta accion controla la creacion de cuentas de los usuarios*/
    ...
    private void BotonCrearCuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonCrearCuentaActionPerformed
        ...
        // Los campos requeridos tienen que estar llenos, eso verifica esta condicion
        if (nom.isEmpty() || apelli.isEmpty() || log.isEmpty() || contra.isEmpty() || confContra.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Por favor, complete todos los campos.");
            return;
        }
        // Esta condicional verifica que las contrasenas sean iguales
        ...
        /*Se crea la cuenta y tambien actualiza el archivo de los usuarios*/
        AccederCuenta acceder=new AccederCuenta();
            ...
            /*En estas tres condicionales se crean los archivos adicionales para la creacion de las cuentas,
            segun la opcion que el usuario haya seleccionado y su tipo de moneda*/
