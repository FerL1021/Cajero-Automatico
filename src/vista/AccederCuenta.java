...
public class AccederCuenta extends javax.swing.JFrame {
 ...
 /*Este ciclo/iterador recorre cada una de las cuentas de lista de cuentas,
        si el inicio de sesion es correcto, al ingresar nos muestra un menu de transacciones;*/
        ...
        /*si no es correcto quiere decir que el usuario no existe o se equivoco al llenar su usuario y password**/
        if (!loginExitoso) {
    ...
    /*Este metodo se encarga de leer las lineas de texto del archivo, en caso
    de que exista un problema nos saldra un mensaje indicando que no se puede leer el archivo,
    el nombre del archivo se pasa como parametro*/
    ...
    /*Este metodo lee el archivo Usuarios, como tal leee cada linea para extraer datos y crear objetos de tipo Cuenta
     con estos datos extraidos y lo agrega a la lista de Cuentas*/
